...
export function buildAgentCard(
  ...
  return {
    name,
    description: `KNOT RangePilot analyzes a pinned PancakeSwap v3 position snapshot and returns a bounded range plan. Analysis only; service payments use BSC testnet.`,
