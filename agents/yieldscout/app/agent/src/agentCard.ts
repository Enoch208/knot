...
export function buildAgentCard(
  ...
  return {
    name,
    description: `KNOT YieldScout compares pinned BSC mainnet same-asset supply markets with explicit rates, incentives, liquidity, risk, and costs. Analysis only; service payments use BSC testnet.`,
