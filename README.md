...
| Can I run it myself? | [Quick start](#quick-start) and [`REPRODUCE.md`](REPRODUCE.md) — `npm run check` runs 780 deterministic tests and needs no secret, key, or RPC endpoint |
